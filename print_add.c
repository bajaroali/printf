...
/****************** PRINT POINTER ******************/
/**
 * print_add - Prints the value of a pointer variable
...
/**
 * print_nprintable - Prints ascii codes in hexa of non printable chars
...
/**
 * print_rotstr - Print a string in rot13.
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
